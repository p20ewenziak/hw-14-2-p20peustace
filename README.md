...
<h2 align="center">
    Due before 8:30 AM on 3/19 (15 pts.)<br>
    https://classroom.github.com/a/gWQdIJ1e
...
Answer each of the following questions in a separate Python file named `hw14-2-#.py` where `#` is the number of the question. In your heading, put your name and the date you began working on the file. 

1. Write a program that makes each of the print statements return `True` for the given function. do not change anything except add code where the comment `# Add code here` is. You may have to add multiple lines of code.
    ```python
...
2. Write a program that prompts the user to input a string and returns a table of the letters of the alphabet in alphabetical order which occur in the string with the frequency each letter occurs. The case of the letters should be ignored. You also should not return the frequency of space characters.
   
    Sample Input: `I LOVE taking my classes online at Prep`
...
3. Modify your program from the previous question to count the frequency of each word that appears in the first chapter of Alice in Wonderland and display the results in a table, and the longest word in the chapter. A string version of the chapter has been provided for you below. The first 10 lines of your output, and the very last line should look like this:
    ```
    Word                Count 
    =========================
    a                   53
    ...
    again               5
    ...
    waistcoat-pocket is the longest word
    ```
    *HINTS: You will have to remove these characters `_` `(` `)` `"` `'` `!` `?` `.` `,` `;` `--` `:` from the string for your count to return only words. Note that the double dashes should be removed, but not single dashes as this would un-hyphenate words. Make sure you copy the triple quotes as they will make the chapter one long string.*
